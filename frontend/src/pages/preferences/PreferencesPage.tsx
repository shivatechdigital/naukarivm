...
export default function PreferencesPage() {
  ...
  const load = async () => {
    try {
      ...
      const data = response.data?.preference || response.data || emptyPreferences
  ...
  const save = async (event: FormEvent) => {
    ...
    const payload = {
      ...
      experienceMin: preferences.experienceMin,
      experienceMax: preferences.experienceMax,
      ...
      matchScoreThreshold: preferences.matchScoreThreshold,
    }
    ...
    try {
      if (preferences.id) {
        ...
        setPreferences(response.data?.preference || response.data)
      }
