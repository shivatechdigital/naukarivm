...
export default function ProfilePage() {
  ...
  const save = async (event: FormEvent) => {
    ...
    const payload = {
      ...profile,
      currentCtc:
        profile.currentCtc === undefined || profile.currentCtc === ''
          ? undefined
          : Number(profile.currentCtc),
      expectedCtc:
        profile.expectedCtc === undefined || profile.expectedCtc === ''
          ? undefined
          : Number(profile.expectedCtc),
      experienceYears:
        profile.experienceYears === undefined || profile.experienceYears === ''
          ? undefined
  ...
  return (
    <div className="animate-in space-y-6 space-x-4" style={{ marginTop: '20px' }}>
      <div>
